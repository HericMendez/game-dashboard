  ...
  return (
    <Sider 
      css={css`
        ...
        z-index: 999;
        direction: ltr;
        ${currentTheme === 'light' && sideNavTheme !== SIDE_NAV_DARK ? `background-color: ${GRAY_SCALE.GRAY_LIGHTER} !important;`  : `background-color: ${TEMPLATE.SIDE_NAV_DARK_BG_COLOR} !important;`}
