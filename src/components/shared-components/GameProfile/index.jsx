  ...
  return (
    ...
    >
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={8}>
          <Image
            src="https://upload.wikimedia.org/wikipedia/pt/0/0f/Legend_of_Zelda_Breath_of_the_Wild_capa.png"
            alt={game.name}
            width="100%"
            height="auto"
            preview={false}
        ...
        <Col xs={24} sm={16}>
          ...
          <Space>
            {game.platforms.map(platform => (
              <Tag key={platform.id} color="green">{platform.name}</Tag>
            ))}
          </Space>
          ...
          <List
            ...
            renderItem={release => (
              <List.Item>
                <Text>{release.platform.name}: {release.human}</Text>
              </List.Item>
            )}
          />
        </Col>
